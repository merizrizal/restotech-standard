                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <?php
                                    echo Html::a('<i class="fa fa-floppy-o"></i> Submit', Yii::$app->urlManager->createUrl([Yii::$app->params['posModule'][$version] . 'home/' . $type.  '-invoice-submit']), ['id' => 'submit', 'class' => 'btn btn-success']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
