                            ...
                            <div class="white-header" style="padding: 10px">
                                <div class="row">
                                    <div class="col-md-6 goleft">
                                        <a id="bayar" class="btn btn-success" href="<?= Yii::$app->urlManager->createUrl(!$isCorrection ? ['action/payment'] : ['action/payment-correction']) ?>"><i class="fa fa-check" style="font-size: 12px; color: white"></i> Bayar</a>
                                    </div>
                                    <div class="col-md-6 goright">
                                        <a id="back" class="btn btn-danger" href="<?= Yii::$app->urlManager->createUrl(['home/open-table', 'id' => $modelMtableSession->mtable->id, 'cid' => $modelMtableSession->mtable->mtable_category_id, 'sessId' => $modelMtableSession->id, 'isCorrection' => $isCorrection]) ?>"><i class="fa fa-undo" style="font-size: 12px; color: white"></i> Back</a>
                                    </div>
                                </div>
                            </div>
                ...
                swal({
                    ...
                    function(result) {
                        ...
                        $.ajax({
                            ...
                            dataType: "json",
                            type: "POST",
                            url: "' . Yii::$app->urlManager->createUrl(['data/limit-karyawan']) . '",
                            data: {
                    ...
                    function(result) {
                        ...
                        if (flag) {
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                type: "POST",
                                url: "' . Yii::$app->urlManager->createUrl(['data/voucher']) . '",
                                data: {
