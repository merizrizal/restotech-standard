...
class MenuSatuanController extends \sybase\SybaseController
{
    ...
    /**
     * Lists all MenuSatuan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MenuSatuanSearch();
    ...
    /**
     * Displays a single MenuSatuan model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MenuSatuan model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MenuSatuan();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $flag = $model->id = Settings::getTransNumber('id_menu_satuan', 'ym', $model->nama_satuan);
    ...
    /**
     * Updates an existing MenuSatuan model.
    ...
    /**
     * Deletes an existing MenuSatuan model.
        ...
        if (($model = $this->findModel($id)) !== false) {
            ...
            try {
                ...
                if ($exc->errorInfo[1] == 1451)
                    $error = '<br>SQLSTATE[23000]: Integrity constraint violation: 1451 Cannot delete or update a parent row: a foreign key constraint fails.';
            }
        }
    ...
    /**
     * Finds the MenuSatuan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return MenuSatuan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MenuSatuan::findOne($id)) !== null) {
            return $model;
        } else {
