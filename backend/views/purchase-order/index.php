...
/* @var $searchModel restotech\standard\backend\models\search\PurchaseOrderSearch */
...
<div class="purchase-order-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'jumlah_item',
            [
                'attribute' => 'purchaseOrderTrxes.item.nama_item',
                'format' => 'raw',
                'value' => function ($model, $index, $widget) {
                    $item = '';
                    foreach ($model->purchaseOrderTrxes as $POTrx) {
                        
                        $item .= $POTrx->item->nama_item . '<br>';
                    }
                    return $item;
                },
            ],
