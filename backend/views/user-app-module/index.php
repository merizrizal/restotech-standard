...
/* @var $searchModel restotech\standard\backend\models\search\UserAppModuleSearch */
                ...
                'buttons' => [
                    ...
                    'delete' =>  function($url, $model, $key) {
                        return Html::a('<i class="fa fa-trash"></i>', $url, [
                            ...
                            'data-placement' => 'top',
                            'title' => 'Delete',
                            'model-id' => $model->nama_module,
                            'model-name' => $model->module_action,
                        ]);
                    },
                ]
            ],
