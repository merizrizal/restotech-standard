...
/* @var $searchModel restotech\standard\backend\models\search\DirectPurchaseSearch */
...
<div class="direct-purchase-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'jumlah_item',
            [
                'attribute' => 'directPurchaseTrxes.item.nama_item',
                'format' => 'raw',
                'value' => function ($model, $index, $widget) {
                    $item = '';
                    foreach ($model->directPurchaseTrxes as $DPTrx) {
                        
                        $item .= $DPTrx->item->nama_item . '<br>';
                    }
                    return $item;
                },
            ],
