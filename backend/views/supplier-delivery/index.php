...
/* @var $searchModel restotech\standard\backend\models\search\SupplierDeliverySearch */
...
<div class="supplier-delivery-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'jumlah_item',
            [
                'attribute' => 'supplierDeliveryTrxes.item.nama_item',
                'format' => 'raw',
                'value' => function ($model, $index, $widget) {
                    $item = '';
                    foreach ($model->supplierDeliveryTrxes as $SDTrx) {
                        
                        $item .= $SDTrx->item->nama_item . '<br>';
                    }
                    return $item;
                },
            ],
