...
/* @var $searchModel restotech\standard\backend\models\search\TransactionCashSearch */
...
$this->params['titleH1'] = '&nbsp;&nbsp;&nbsp;' . Html::a('<i class="fa fa-upload"></i>&nbsp;&nbsp;&nbsp;' . 'Create New Data', ['create', 'type' => $type], ['class' => 'btn btn-success']);
$this->params['breadcrumbs'][] = $this->title; ?>

<div class="transaction-cash-index">
    ...
    <?= GridView::widget([
        ...
        'toolbar' => [
            [
                'content' => Html::a('<i class="fa fa-repeat"></i>', ['index', 'type' => $type], [
                            'data-pjax'=>false, 
