...
$dataMenu = Tools::array_sort($dataMenu, 'qty', SORT_DESC); ?>
    ...
    <div class="row">
        <div class="col-lg-12">                
            <table class="table" style="border: none">
                <tbody style="border: none; font-weight: bold">
                    <tr>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 10px">:</td>       
                                        <td class="number" style="width: 150px"><?= Tools::convertToCurrency($jumlahGrandTotal, ($print == 'pdf')) ?></td>       
                                    </tr>                                                                                                                
                                </tbody>
                            </table>
