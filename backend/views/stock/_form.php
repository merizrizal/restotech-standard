        ...
        <div class="box box-danger">
            <div class="box-body">
                <div class="stock-form">
                    ...
                    <?= $form->field($model, 'item_id')->textInput(['maxlength' => 16]) ?>

                    <?= $form->field($model, 'item_sku_id')->textInput(['maxlength' => 16]) ?>

                    <?= $form->field($model, 'jumlah_stok')->textInput() ?>

                    <?= $form->field($model, 'storage_id')->textInput(['maxlength' => 12]) ?>

                    <?= $form->field($model, 'storage_rack_id')->textInput(['maxlength' => 20]) ?>
