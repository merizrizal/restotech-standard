...
/* @var $searchModel restotech\standard\backend\models\search\MtableSearch */
...
$this->title = 'Meja Ruangan ' . $searchModel->mtableCategory->nama_category;
$this->params['titleH1'] = '&nbsp;&nbsp;&nbsp;' . Html::a('<i class="fa fa-upload"></i>&nbsp;&nbsp;&nbsp;' . 'Create New Data', ['create', 'cid' => $searchModel->mtable_category_id], ['class' => 'btn btn-success']);        
$this->params['breadcrumbs'][] = ['label' => 'Ruangan', 'url' => ['mtable-category/index']];
$this->params['breadcrumbs'][] = $this->title; ?>

<div class="mtable-index">
    ...
    <?= GridView::widget([
        ...
        'toolbar' => [
            ['content'=>
                Html::a('<i class="fa fa-repeat"></i>', ['index', 'cid' => $searchModel->mtable_category_id], [
                    'data-pjax'=>false, 
