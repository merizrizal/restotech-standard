...
/* @var $searchModel restotech\standard\backend\models\search\MenuCategorySearch */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $index, $widget) {
                    return Html::checkbox('is_antrian[]', $model->not_active, ['value' => $index, 'disabled' => 'disabled']);
                },
            ],
