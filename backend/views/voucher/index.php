...
/* @var $searchModel restotech\standard\backend\models\search\VoucherSearch */
...
<div class="voucher-index">
    ...
    $jscript = '$(\'[data-toggle="tooltip"]\').tooltip();'
            . '$("input[name=\"VoucherSearch[start_date]\"").inputmask("yyyy-mm-dd", {"placeholder": "yyyy-mm-dd"});'
            . '$("input[name=\"VoucherSearch[end_date]\"").inputmask("yyyy-mm-dd", {"placeholder": "yyyy-mm-dd"});'
            ...
            [
                ...
                'value' => function ($model, $index, $widget) {
                    if ($model->voucher_type === 'Percent')
                        return Yii::$app->formatter->asDecimal($model->jumlah_voucher) . ' %';
                    else if ($model->voucher_type === 'Value')
                        return Yii::$app->formatter->asCurrency($model->jumlah_voucher);
                },
            ],
            'start_date:date',
            'end_date:date',
