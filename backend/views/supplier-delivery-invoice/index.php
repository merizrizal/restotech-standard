...
/* @var $searchModel restotech\standard\backend\models\search\SupplierDeliveryInvoiceSearch */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '<div class="btn-group btn-group-xs" role="group" style="width: 125px">'
                                    . '{view}{update}{delete}{pembayaran}'
                            . '</div>',
                'buttons' => [
                    ...
                    'pembayaran' =>  function($url, $model, $key) {
                        return Html::a('<i class="fa fa-dollar"></i>', ['supplier-delivery-invoice-payment/create', 'id' => $model->id], [
                            'id' => 'view',
