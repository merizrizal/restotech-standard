...
use backend\models\search\TransactionAccountSearch;
...
class TransactionAccountController extends SybaseController
{
    ...
    /**
     * Lists all TransactionAccount models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TransactionAccountSearch();
    ...
    /**
     * Displays a single TransactionAccount model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TransactionAccount model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TransactionAccount();
    ...
    /**
     * Updates an existing TransactionAccount model.
    ...
    /**
     * Deletes an existing TransactionAccount model.
