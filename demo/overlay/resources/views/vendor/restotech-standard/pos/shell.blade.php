...
<head>
    ...
    <title>{{ config('restotech-standard.package.name') }} POS Demo</title>
...
<main>
    <div
        ...
        data-demo-table-id="{{ config('restotech-standard.demo.table_id', 1) }}"
    >
        <section class="shell grid">
            <header>
                <h1>Restotech POS Demo</h1>
                <p class="note">The seeded table ID is prefilled so you can open a live table session immediately.</p>
            </header>
